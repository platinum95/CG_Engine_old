...
#pragma region TerrainGenerator
	...
	MeshData TerrainGenerator::CreateMesh(uint32_t MeshSize, uint32_t Divisions) {
	...
	std::vector<float> TerrainGenerator::GenerateHeights(int MeshSize, int DivisionCount, int GridX, int GridZ) {
	...
	std::vector<glm::vec3> TerrainGenerator::GetSmoothNormals(const MeshData &meshData, const std::vector<float> Heights) {
	...
	ChunkData TerrainGenerator::GenerateChunk(int GridX, int GridZ, const MeshData &meshData) {
...
#pragma region TerrainChunk
	...
	TerrainChunk::TerrainChunk(const MeshBaseVBOs &baseVBOs, const MeshData &meshData, int GridX, int GridZ) {
...
#pragma region Terrain
	...
	std::shared_ptr<TerrainChunk> Terrain::GenerateChunk(int xGrid, int zGrid) {
	...
	std::unique_ptr<RenderPass> Terrain::GetRenderPass(Shader *_GroundShader) {
